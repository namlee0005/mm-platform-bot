...
const file_PublicDealsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x16PublicDealsV3Api.proto\x12\x04mexc\"b\n" +
	"\x10PublicDealsV3Api\x120\n" +
	"\x05deals\x18\x01 \x03(\v2\x1a.mexc.PublicDealsV3ApiItemR\x05deals\x12\x1c\n" +
	...
	"\x04time\x18\x04 \x01(\x03R\x04timeBj\n" +
	"\x1ccom.mxc.push.common.protobufB\x15PublicDealsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicDealsV3Api_proto_goTypes = []any{
	(*PublicDealsV3Api)(nil),     // 0: mexc.PublicDealsV3Api
	(*PublicDealsV3ApiItem)(nil), // 1: mexc.PublicDealsV3ApiItem
}
var file_PublicDealsV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicDealsV3Api.deals:type_name -> mexc.PublicDealsV3ApiItem
