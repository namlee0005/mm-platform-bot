...
const file_PushDataV3ApiWrapper_proto_rawDesc = "" +
	"\n" +
	"\x1aPushDataV3ApiWrapper.proto\x12\x04mexc\x1a\x16PublicDealsV3Api.proto\x1a\x1fPublicIncreaseDepthsV3Api.proto\x1a\x1cPublicLimitDepthsV3Api.proto\x1a\x18PrivateOrdersV3Api.proto\x1a\x1bPublicBookTickerV3Api.proto\x1a\x17PrivateDealsV3Api.proto\x1a\x19PrivateAccountV3Api.proto\x1a\x1aPublicSpotKlineV3Api.proto\x1a\x1bPublicMiniTickerV3Api.proto\x1a\x1cPublicMiniTickersV3Api.proto\x1a PublicBookTickerBatchV3Api.proto\x1a$PublicIncreaseDepthsBatchV3Api.proto\x1a\x1cPublicAggreDepthsV3Api.proto\x1a\x1bPublicAggreDealsV3Api.proto\x1a PublicAggreBookTickerV3Api.proto\"\x85\v\n" +
	"\x14PushDataV3ApiWrapper\x12\x18\n" +
	"\achannel\x18\x01 \x01(\tR\achannel\x12;\n" +
	"\vpublicDeals\x18\xad\x02 \x01(\v2\x16.mexc.PublicDealsV3ApiH\x00R\vpublicDeals\x12V\n" +
	"\x14publicIncreaseDepths\x18\xae\x02 \x01(\v2\x1f.mexc.PublicIncreaseDepthsV3ApiH\x00R\x14publicIncreaseDepths\x12M\n" +
	"\x11publicLimitDepths\x18\xaf\x02 \x01(\v2\x1c.mexc.PublicLimitDepthsV3ApiH\x00R\x11publicLimitDepths\x12A\n" +
	"\rprivateOrders\x18\xb0\x02 \x01(\v2\x18.mexc.PrivateOrdersV3ApiH\x00R\rprivateOrders\x12J\n" +
	"\x10publicBookTicker\x18\xb1\x02 \x01(\v2\x1b.mexc.PublicBookTickerV3ApiH\x00R\x10publicBookTicker\x12>\n" +
	"\fprivateDeals\x18\xb2\x02 \x01(\v2\x17.mexc.PrivateDealsV3ApiH\x00R\fprivateDeals\x12D\n" +
	"\x0eprivateAccount\x18\xb3\x02 \x01(\v2\x19.mexc.PrivateAccountV3ApiH\x00R\x0eprivateAccount\x12G\n" +
	"\x0fpublicSpotKline\x18\xb4\x02 \x01(\v2\x1a.mexc.PublicSpotKlineV3ApiH\x00R\x0fpublicSpotKline\x12J\n" +
	"\x10publicMiniTicker\x18\xb5\x02 \x01(\v2\x1b.mexc.PublicMiniTickerV3ApiH\x00R\x10publicMiniTicker\x12M\n" +
	"\x11publicMiniTickers\x18\xb6\x02 \x01(\v2\x1c.mexc.PublicMiniTickersV3ApiH\x00R\x11publicMiniTickers\x12Y\n" +
	"\x15publicBookTickerBatch\x18\xb7\x02 \x01(\v2 .mexc.PublicBookTickerBatchV3ApiH\x00R\x15publicBookTickerBatch\x12e\n" +
	"\x19publicIncreaseDepthsBatch\x18\xb8\x02 \x01(\v2$.mexc.PublicIncreaseDepthsBatchV3ApiH\x00R\x19publicIncreaseDepthsBatch\x12M\n" +
	"\x11publicAggreDepths\x18\xb9\x02 \x01(\v2\x1c.mexc.PublicAggreDepthsV3ApiH\x00R\x11publicAggreDepths\x12J\n" +
	"\x10publicAggreDeals\x18\xba\x02 \x01(\v2\x1b.mexc.PublicAggreDealsV3ApiH\x00R\x10publicAggreDeals\x12Y\n" +
	"\x15publicAggreBookTicker\x18\xbb\x02 \x01(\v2 .mexc.PublicAggreBookTickerV3ApiH\x00R\x15publicAggreBookTicker\x12\x1b\n" +
	...
	"\v_createTimeB\v\n" +
	"\t_sendTimeBn\n" +
	"\x1ccom.mxc.push.common.protobufB\x19PushDataV3ApiWrapperProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PushDataV3ApiWrapper_proto_goTypes = []any{
	...
	(*PublicDealsV3Api)(nil),               // 1: mexc.PublicDealsV3Api
	(*PublicIncreaseDepthsV3Api)(nil),      // 2: mexc.PublicIncreaseDepthsV3Api
	(*PublicLimitDepthsV3Api)(nil),         // 3: mexc.PublicLimitDepthsV3Api
	(*PrivateOrdersV3Api)(nil),             // 4: mexc.PrivateOrdersV3Api
	(*PublicBookTickerV3Api)(nil),          // 5: mexc.PublicBookTickerV3Api
	(*PrivateDealsV3Api)(nil),              // 6: mexc.PrivateDealsV3Api
	(*PrivateAccountV3Api)(nil),            // 7: mexc.PrivateAccountV3Api
	(*PublicSpotKlineV3Api)(nil),           // 8: mexc.PublicSpotKlineV3Api
	(*PublicMiniTickerV3Api)(nil),          // 9: mexc.PublicMiniTickerV3Api
	(*PublicMiniTickersV3Api)(nil),         // 10: mexc.PublicMiniTickersV3Api
	(*PublicBookTickerBatchV3Api)(nil),     // 11: mexc.PublicBookTickerBatchV3Api
	(*PublicIncreaseDepthsBatchV3Api)(nil), // 12: mexc.PublicIncreaseDepthsBatchV3Api
	(*PublicAggreDepthsV3Api)(nil),         // 13: mexc.PublicAggreDepthsV3Api
	(*PublicAggreDealsV3Api)(nil),          // 14: mexc.PublicAggreDealsV3Api
	(*PublicAggreBookTickerV3Api)(nil),     // 15: mexc.PublicAggreBookTickerV3Api
}
var file_PushDataV3ApiWrapper_proto_depIdxs = []int32{
	1,  // 0: mexc.PushDataV3ApiWrapper.publicDeals:type_name -> mexc.PublicDealsV3Api
	2,  // 1: mexc.PushDataV3ApiWrapper.publicIncreaseDepths:type_name -> mexc.PublicIncreaseDepthsV3Api
	3,  // 2: mexc.PushDataV3ApiWrapper.publicLimitDepths:type_name -> mexc.PublicLimitDepthsV3Api
	4,  // 3: mexc.PushDataV3ApiWrapper.privateOrders:type_name -> mexc.PrivateOrdersV3Api
	5,  // 4: mexc.PushDataV3ApiWrapper.publicBookTicker:type_name -> mexc.PublicBookTickerV3Api
	6,  // 5: mexc.PushDataV3ApiWrapper.privateDeals:type_name -> mexc.PrivateDealsV3Api
	7,  // 6: mexc.PushDataV3ApiWrapper.privateAccount:type_name -> mexc.PrivateAccountV3Api
	8,  // 7: mexc.PushDataV3ApiWrapper.publicSpotKline:type_name -> mexc.PublicSpotKlineV3Api
	9,  // 8: mexc.PushDataV3ApiWrapper.publicMiniTicker:type_name -> mexc.PublicMiniTickerV3Api
	10, // 9: mexc.PushDataV3ApiWrapper.publicMiniTickers:type_name -> mexc.PublicMiniTickersV3Api
	11, // 10: mexc.PushDataV3ApiWrapper.publicBookTickerBatch:type_name -> mexc.PublicBookTickerBatchV3Api
	12, // 11: mexc.PushDataV3ApiWrapper.publicIncreaseDepthsBatch:type_name -> mexc.PublicIncreaseDepthsBatchV3Api
	13, // 12: mexc.PushDataV3ApiWrapper.publicAggreDepths:type_name -> mexc.PublicAggreDepthsV3Api
	14, // 13: mexc.PushDataV3ApiWrapper.publicAggreDeals:type_name -> mexc.PublicAggreDealsV3Api
	15, // 14: mexc.PushDataV3ApiWrapper.publicAggreBookTicker:type_name -> mexc.PublicAggreBookTickerV3Api
