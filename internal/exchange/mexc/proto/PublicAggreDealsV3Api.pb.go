...
const file_PublicAggreDealsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1bPublicAggreDealsV3Api.proto\x12\x04mexc\"l\n" +
	"\x15PublicAggreDealsV3Api\x125\n" +
	"\x05deals\x18\x01 \x03(\v2\x1f.mexc.PublicAggreDealsV3ApiItemR\x05deals\x12\x1c\n" +
	...
	"\x04time\x18\x04 \x01(\x03R\x04timeBo\n" +
	"\x1ccom.mxc.push.common.protobufB\x1aPublicAggreDealsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicAggreDealsV3Api_proto_goTypes = []any{
	(*PublicAggreDealsV3Api)(nil),     // 0: mexc.PublicAggreDealsV3Api
	(*PublicAggreDealsV3ApiItem)(nil), // 1: mexc.PublicAggreDealsV3ApiItem
}
var file_PublicAggreDealsV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicAggreDealsV3Api.deals:type_name -> mexc.PublicAggreDealsV3ApiItem
