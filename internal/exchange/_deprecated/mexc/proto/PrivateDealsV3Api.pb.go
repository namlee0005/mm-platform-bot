...
const file_PrivateDealsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x17PrivateDealsV3Api.proto\x12\x04mexc\"\xe5\x02\n" +
	...
	"\x04time\x18\f \x01(\x03R\x04timeBk\n" +
	"\x1ccom.mxc.push.common.protobufB\x16PrivateDealsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PrivateDealsV3Api_proto_goTypes = []any{
	(*PrivateDealsV3Api)(nil), // 0: mexc.PrivateDealsV3Api
}
