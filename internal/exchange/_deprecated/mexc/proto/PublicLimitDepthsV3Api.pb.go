...
const file_PublicLimitDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1cPublicLimitDepthsV3Api.proto\x12\x04mexc\"\xba\x01\n" +
	"\x16PublicLimitDepthsV3Api\x123\n" +
	"\x04asks\x18\x01 \x03(\v2\x1f.mexc.PublicLimitDepthV3ApiItemR\x04asks\x123\n" +
	"\x04bids\x18\x02 \x03(\v2\x1f.mexc.PublicLimitDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\bquantity\x18\x02 \x01(\tR\bquantityBp\n" +
	"\x1ccom.mxc.push.common.protobufB\x1bPublicLimitDepthsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicLimitDepthsV3Api_proto_goTypes = []any{
	(*PublicLimitDepthsV3Api)(nil),    // 0: mexc.PublicLimitDepthsV3Api
	(*PublicLimitDepthV3ApiItem)(nil), // 1: mexc.PublicLimitDepthV3ApiItem
}
var file_PublicLimitDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicLimitDepthsV3Api.asks:type_name -> mexc.PublicLimitDepthV3ApiItem
	1, // 1: mexc.PublicLimitDepthsV3Api.bids:type_name -> mexc.PublicLimitDepthV3ApiItem
