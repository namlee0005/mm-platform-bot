...
const file_PublicIncreaseDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1fPublicIncreaseDepthsV3Api.proto\x12\x04mexc\"\xc3\x01\n" +
	"\x19PublicIncreaseDepthsV3Api\x126\n" +
	"\x04asks\x18\x01 \x03(\v2\".mexc.PublicIncreaseDepthV3ApiItemR\x04asks\x126\n" +
	"\x04bids\x18\x02 \x03(\v2\".mexc.PublicIncreaseDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\bquantity\x18\x02 \x01(\tR\bquantityBs\n" +
	"\x1ccom.mxc.push.common.protobufB\x1ePublicIncreaseDepthsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicIncreaseDepthsV3Api_proto_goTypes = []any{
	(*PublicIncreaseDepthsV3Api)(nil),    // 0: mexc.PublicIncreaseDepthsV3Api
	(*PublicIncreaseDepthV3ApiItem)(nil), // 1: mexc.PublicIncreaseDepthV3ApiItem
}
var file_PublicIncreaseDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicIncreaseDepthsV3Api.asks:type_name -> mexc.PublicIncreaseDepthV3ApiItem
	1, // 1: mexc.PublicIncreaseDepthsV3Api.bids:type_name -> mexc.PublicIncreaseDepthV3ApiItem
