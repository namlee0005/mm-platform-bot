...
const file_PublicIncreaseDepthsBatchV3Api_proto_rawDesc = "" +
	"\n" +
	"$PublicIncreaseDepthsBatchV3Api.proto\x12\x04mexc\x1a\x1fPublicIncreaseDepthsV3Api.proto\"u\n" +
	"\x1ePublicIncreaseDepthsBatchV3Api\x125\n" +
	"\x05items\x18\x01 \x03(\v2\x1f.mexc.PublicIncreaseDepthsV3ApiR\x05items\x12\x1c\n" +
	"\teventType\x18\x02 \x01(\tR\teventTypeBx\n" +
	"\x1ccom.mxc.push.common.protobufB#PublicIncreaseDepthsBatchV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicIncreaseDepthsBatchV3Api_proto_goTypes = []any{
	(*PublicIncreaseDepthsBatchV3Api)(nil), // 0: mexc.PublicIncreaseDepthsBatchV3Api
	(*PublicIncreaseDepthsV3Api)(nil),      // 1: mexc.PublicIncreaseDepthsV3Api
}
var file_PublicIncreaseDepthsBatchV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicIncreaseDepthsBatchV3Api.items:type_name -> mexc.PublicIncreaseDepthsV3Api
