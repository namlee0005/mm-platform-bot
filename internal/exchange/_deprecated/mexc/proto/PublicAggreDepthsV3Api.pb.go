...
const file_PublicAggreDepthsV3Api_proto_rawDesc = "" +
	"\n" +
	"\x1cPublicAggreDepthsV3Api.proto\x12\x04mexc\"\xe0\x01\n" +
	"\x16PublicAggreDepthsV3Api\x123\n" +
	"\x04asks\x18\x01 \x03(\v2\x1f.mexc.PublicAggreDepthV3ApiItemR\x04asks\x123\n" +
	"\x04bids\x18\x02 \x03(\v2\x1f.mexc.PublicAggreDepthV3ApiItemR\x04bids\x12\x1c\n" +
	...
	"\x1ccom.mxc.push.common.protobufB\x1bPublicAggreDepthsV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicAggreDepthsV3Api_proto_goTypes = []any{
	(*PublicAggreDepthsV3Api)(nil),    // 0: mexc.PublicAggreDepthsV3Api
	(*PublicAggreDepthV3ApiItem)(nil), // 1: mexc.PublicAggreDepthV3ApiItem
}
var file_PublicAggreDepthsV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicAggreDepthsV3Api.asks:type_name -> mexc.PublicAggreDepthV3ApiItem
	1, // 1: mexc.PublicAggreDepthsV3Api.bids:type_name -> mexc.PublicAggreDepthV3ApiItem
