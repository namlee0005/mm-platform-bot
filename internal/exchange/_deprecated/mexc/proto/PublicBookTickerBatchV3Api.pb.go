...
const file_PublicBookTickerBatchV3Api_proto_rawDesc = "" +
	"\n" +
	" PublicBookTickerBatchV3Api.proto\x12\x04mexc\x1a\x1bPublicBookTickerV3Api.proto\"O\n" +
	"\x1aPublicBookTickerBatchV3Api\x121\n" +
	"\x05items\x18\x01 \x03(\v2\x1b.mexc.PublicBookTickerV3ApiR\x05itemsBt\n" +
	"\x1ccom.mxc.push.common.protobufB\x1fPublicBookTickerBatchV3ApiProtoH\x01P\x01Z/mm-platform-engine/internal/exchange/mexc/protob\x06proto3"
...
var file_PublicBookTickerBatchV3Api_proto_goTypes = []any{
	(*PublicBookTickerBatchV3Api)(nil), // 0: mexc.PublicBookTickerBatchV3Api
	(*PublicBookTickerV3Api)(nil),      // 1: mexc.PublicBookTickerV3Api
}
var file_PublicBookTickerBatchV3Api_proto_depIdxs = []int32{
	1, // 0: mexc.PublicBookTickerBatchV3Api.items:type_name -> mexc.PublicBookTickerV3Api
